...
export default function BillingPage() {
  ...
  return (
    <div className="flex flex-col md:flex-row h-full overflow-hidden">
      {/* Cart Panel (Left on desktop) */}
      <div className="hidden md:flex w-1/3 min-w-[320px] max-w-[400px] border-r border-border flex-col z-10 bg-white">
        <h2 className="font-headings font-bold text-lg p-4 border-b border-border shadow-sm">Current Order</h2>
      ...
      {cartItemCount > 0 && (
        <div className="md:hidden fixed bottom-4 left-4 right-4 z-50">
          <Sheet>
            ...
            <SheetContent side="bottom" className="h-[85vh] p-0 flex flex-col rounded-t-3xl border-t-0">
